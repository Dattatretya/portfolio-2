  ...
  return (
    ...
    <div className='m-2 p-2 flex-row justify-center'>
      ...
      <div className='flex h-16'>
        <a className='items-center p-1 border border-cyan-400 text-white m-2 rounded-md hover:text-lime-200 animate-pulse hidden md:block' href='https://www.linkedin.com/in/dattatreya-sengupta-7627a1148/' target='_blank'>LinkedIn</a>
        <a className='items-center p-1 border border-cyan-400 text-white m-2 rounded-md hover:text-lime-200 animate-pulse hidden md:block' href='https://github.com/Dattatretya' target='_blank'>Github</a>
        <a className='items-center p-1 border border-cyan-400 text-white m-2 rounded-md hover:text-lime-200 animate-pulse hidden md:block' href={Resume} target='_blank' download="Dattatreya Sengupta Resume">Download Resume</a>
        </div>

      </div>
      
      <div className=''>
      <div className='bg-violet-900 rounded-2xl m-2 text-violet-600 font-mono p-4'>
      ...
      <div className='bg-white h-auto rounded-2xl p-4 font-mono m-2 my-4'>
      ...
      <div className='bg-violet-900 rounded-2xl m-2 text-violet-600 font-mono p-2'>
