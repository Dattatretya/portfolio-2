...
const Work = () => {
  return (
    <div className='text-white flex flex-wrap justify-center items-center m-2 p-2'>
      ...
      <WorkCard live="https://weatherapp-dattatreya.netlify.app/" img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAyw3ZyD5FktfuYtkbw1zWT12Zs5xolOlJyukF1xOxgQ&s" name="Weather App" github="https://github.com/Dattatretya/Intern-Kaksha-Weatherapp"/>
      ...
      <WorkCard live="" img="https://t3.ftcdn.net/jpg/04/74/05/94/360_F_474059464_qldYuzxaUWEwNTtYBJ44VN89ARuFktHW.jpg" name="Youtube Clone (ongoing)" github="https://github.com/Dattatretya/namaste-youtube"/>
    </div>
  )
}
