...
const Body = () => {
  ...
  return (
    ...
    {/* welcome message */}
      ...
      {/* Name and links  */}
      <div className='flex justify-center items-center m-6 p-3 mt-20 animate-pulse hover:animate-none md:bg-black rounded-lg'>
        <img className='h-36 mx-3 rounded-lg animate-none' src='https://i.postimg.cc/BvTds2cd/IMG-20240503-063654-277.jpg' alt='' />
      ...
      {skills===true? 
      (<div className='p-6 m-4 flex justify-center font-bold text-lg'>Software Engineer with proficiency is Frontend Development. Aspiring MERN stack developer.</div>) 
      : 
      (<div className='p-6 m-4 flex justify-center'>
